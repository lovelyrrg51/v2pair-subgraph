...
import { USDTPair as PairContract, Mint, Burn, Swap, Transfer, Sync } from '../generated/WETHUSDTPair/USDTPair'
...
export function handleSync(event: Sync): void {
  ...
  newSyncData.block = event.block.number.toI32()
  newSyncData.reserve0 = pair!.reserve0
  newSyncData.reserve1 = pair!.reserve1
  newSyncData.ethPrice = bundle!.ethPrice
  newSyncData.token0PriceUSD = token0!.derivedETH!.times(bundle!.ethPrice)
  newSyncData.token1PriceUSD = token1!.derivedETH!.times(bundle!.ethPrice)
  newSyncData.reserveUSD = pair!.reserveUSD
